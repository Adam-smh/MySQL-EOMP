...
class Login:
    def __init__(self, master):
        ...
        self.signin.place(relx="0.3", rely="0.4")
        ...
        self.addb = Button(self.frame, text="Add", font="Google-Sans 10", bg="white", fg="#007f5f", width="12",
                            ...
                            self.add)
        self.addb.place(relx="0.35", rely="0.8")
    ...
    def add(self):
        ...
        if len(P) != 8:
            messagebox.showerror("Error", "Passwoed must be 8 characters long")

        elif result1 or result2:
            messagebox.showerror("Error", "Info already exists")

        elif not result1 and not result2:
            log_1 = "insert into Admin (ID, Pass) values ('{}', '{}')".format(ID, P)
